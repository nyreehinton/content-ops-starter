...
import { producerImplications, consumerImplications, calMaineImpact, keyTakeaway } from '../../data/analysisData';
            ...
            <div className={styles.contentColumns}>
                <div className={styles.mainColumn}>
                    <div className={styles.contentBlock}>
                        ...
                        <div className={styles.impactAnalysis}>
                            <h4 className={styles.contentSubtitle}>California & Maine Regulations: Impact Assessment </h4>
                            ...
                            <div className={styles.implicationsContainer}>
                                <div className={styles.implicationsColumn}>
                                    <div className={styles.implicationsHeader}>
                                        <i className="fas fa-industry"> </i> <h5> For Producers </h5>{' '}
                                    </div>{' '}
                                ...
                                <div className={styles.implicationsColumn}>
                                    <div className={styles.implicationsHeader}>
                                        <i className="fas fa-shopping-cart"> </i> <h5> For Consumers </h5>{' '}
                                    </div>{' '}
                                    <ul className={styles.implicationsList}>
                                        {' '}
                        ...
                        <div className={styles.keyTakeaway}>
                            <div className={styles.takeawayHeader}>
                                <i className="fas fa-lightbulb"> </i> <h4> Key Takeaway </h4>{' '}
                            </div>{' '}
                            <blockquote className={styles.takeawayQuote}> {keyTakeaway} </blockquote>{' '}
                        </div>{' '}
                    </div>{' '}
                </div>
                <div className={styles.sideColumn}>
                    ...
                    <div className={styles.infoBox}>
                        <h4>
                            <i className="fas fa-chart-line"> </i>3 - Year Outlook{' '}
                        </h4>{' '}
                        <div className={styles.outlookCard}>
                            <div className={styles.outlookHeader}> Price Projection </div>{' '}
                            <div className={styles.outlookChart}>
                                {' '}
                                {/* Placeholder for chart */} <img src="/images/price-projection.png" alt="3-Year Price Projection" />
                            </div>{' '}
                        ...
                        <div className={styles.actionsList}>
                            <div className={styles.actionItem}>
                                <div className={styles.actionTitle}>
                                    <i className="fas fa-file-alt"> </i> <span> Download Full Report </span>{' '}
                                </div>{' '}
                            </div>{' '}
                            <div className={styles.actionItem}>
                                <div className={styles.actionTitle}>
                                    <i className="fas fa-chart-pie"> </i> <span> View Interactive Data </span>{' '}
                                </div>{' '}
                            </div>{' '}
                            <div className={styles.actionItem}>
                                <div className={styles.actionTitle}>
                                    <i className="fas fa-user-tie"> </i> <span> Speak with an Analyst </span>{' '}
                                </div>{' '}
                            </div>{' '}
                            <div className={styles.actionItem}>
                                <div className={styles.actionTitle}>
                                    <i className="fas fa-rss"> </i> <span> Subscribe to Updates </span>{' '}
                                </div>{' '}
                            </div>{' '}
                        </div>{' '}
                    </div>{' '}
