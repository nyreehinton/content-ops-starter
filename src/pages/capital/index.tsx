...
export default function CapitalGroupDashboard({ htmlContent }: Props) {
  useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Capital Group ETF Dashboard - Glass Elegance</title>
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'pages', 'capital', 'index.html');
