...
export default function TeslaDashboard({ htmlContent }: Props) {
  useEffect(() => {
  ...
  return (
    <>
      <Head>
        <title>Tesla Dashboard - Glass Elegance</title>
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'pages', 'tesla', 'index.html');
