...
interface BloombergStockPerformanceChartProps {
  className?: string;
  title?: string;
  subtitle?: string;
  [key: string]: any;
...
const BloombergStockPerformanceChart: React.FC<BloombergStockPerformanceChartProps> = ({ 
  className,
  title = 'ams-SW Stock Performance vs Semiconductor Index',
  subtitle,
  ...rest
}) => {
  // Sample data for ams-SW and Semiconductor Index - same as in the bloomberg1_backup.md file
  const data = {
...
export default BloombergStockPerformanceChart; 