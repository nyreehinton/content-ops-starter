...
import { industryData, structuralChallenges } from '../../../data/thirdbridge/analysisData';
          ...
          <div className={styles.contentBlock}>
            ...
            <div className={styles.industryDiagram}>
              <div className={styles.diagramHeader}>
                U.S. Egg Industry Structure
              </div>
              <div className={styles.diagramContent}>
                <div className={styles.diagramImage}>
                  {/* Placeholder for actual SVG or image diagram */}
                  <div className={styles.svgPlaceholder}>
                    <img src="/images/thirdbridge/thirdbridge/industry-structure.svg" alt="Egg Industry Structure" />
                  </div>
                </div>
              </div>
              <div className={styles.diagramFooter}>
                Source: USDA Economic Research Service, ThirdBridge Analysis
              </div>
            </div>
            ...
            <div className={styles.regulationsList}>
              {industryData.regulations.map((regulation, index) => (
                <div key={index} className={styles.regulationItem}>
                  ...
                  <div className={styles.regulationImpact} style={{ 
                    backgroundColor: regulation.impact === 'high' ? '#EF4444' : 
                                   regulation.impact === 'medium' ? '#F59E0B' : '#10B981' 
                  }}>
                    {regulation.impact}
                  </div>
                </div>
