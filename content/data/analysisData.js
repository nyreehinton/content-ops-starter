...
export const mainArticle = {
    ...
    analyst: {
        ...
        bio: 'Dr. Chen specializes in agricultural economics with a focus on protein markets and food supply chains. She has published extensively on market structure and pricing dynamics in the egg and poultry sectors.'
    }
};
...
export const calMaineImpact = [
    {
        ...
        description:
            'The cage-free requirements effectively created a two-tier market, with compliant eggs commanding a premium and reducing overall supply flexibility.',
...
export const keyTakeaway =
    'The 2025 egg price crisis demonstrates how underlying vulnerabilities can turn a significant but manageable disease outbreak into a market-wide crisis that affects millions of consumers. Understanding these structural factors is essential for developing more resilient agricultural systems.';
...
export const featuredAnalyses = [
    {
        ...
        imageUrl: '/images/dairy-industry.jpg',
    ...
    },
    {
        ...
        imageUrl: '/images/alt-proteins.jpg',
    ...
    },
    {
        ...
        imageUrl: '/images/farm-labor.jpg',
